...
class Task
{
  ...
  public:
    ...
    void init(unsigned long wcet, unsigned long period, unsigned long deadline = 0, unsigned long pp = 0);
    Task(unsigned long wcet = 0,
         unsigned long period = 0,
         unsigned long deadline = 0,
         unsigned long pp = 0) { init(wcet, period, deadline, pp); }
...
class TaskSet
{
  ...
  public:
    ...
    {
        tasks.push_back(Task(wcet, period, deadline, pp));
    }
